<template>
  <div class="assetsChgDetail">
    <my-pageheader titleContent="固定资产变动详情"></my-pageheader>
    ...
    initData(id) {
      ...
      this.axios.get(url).then(res => {
        if (res.success) {
          ...
          if (
            this.userInfo.id === this.assetsChgForm.creater &&
            this.assetsChgForm.status === "审核中"
          ) {
            this.show = true;
          }
        }
