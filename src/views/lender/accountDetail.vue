  ...
  <div class="accountDetail">
    ...
    <el-table cell-class-name="centerAlign" :data="tableData" stripe style="width: 100%">
      ...
      <el-table-column align="center" label="凭证">
        <el-table-column align="center" prop="voucher.bizDate" label="业务日期"></el-table-column>
        <el-table-column align="center" prop="voucher.bizCode" label="业务单号"></el-table-column>
      ...
      <el-table-column align="center" label="期初余额">
        <el-table-column align="center" prop="accountBalance.debitStaperiodAmt" label="借方"></el-table-column>
        <el-table-column align="center" prop="accountBalance.creditStaperiodAmt" label="贷方"></el-table-column>
      </el-table-column>
      ...
      <el-table-column align="center" label="期末余额">
        <el-table-column align="center" prop="accountBalance.debitEndperiodAmt" label="借方"></el-table-column>
        <el-table-column align="center" prop="accountBalance.creditEndperiodAmt" label="贷方"></el-table-column>
      </el-table-column>
    </el-table>
     <el-row>
      <el-col :span="24">
